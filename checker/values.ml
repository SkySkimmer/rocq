...
let rec v_constr =
  Sum ("constr",0,[|
    ...
    [|Fail "Evar";Int|]; (* Evar *)
    [|v_sort;Int|]; (* Sort *)
    [|v_constr;v_cast;v_constr;Int|]; (* Cast *)
    [|v_binder_annot v_name;v_constr;v_constr;Int|]; (* Prod *)
    [|v_binder_annot v_name;v_constr;v_constr;Int|]; (* Lambda *)
    [|v_binder_annot v_name;v_constr;v_constr;v_constr;Int|]; (* LetIn *)
    [|v_constr;Array v_constr;Int|]; (* App *)
    [|v_puniverses v_cst;Int|]; (* Const *)
    [|v_puniverses v_ind;Int|]; (* Ind *)
    [|v_puniverses v_cons;Int|]; (* Construct *)
    [|v_caseinfo;v_instance; Array v_constr; v_case_return; v_case_invert; v_constr; Array v_case_branch;Int|]; (* Case *)
    [|v_fix;Int|]; (* Fix *)
    [|v_cofix;Int|]; (* CoFix *)
    [|v_proj;v_constr;Int|]; (* Proj *)
    [|v_uint63|]; (* Int *)
    [|Float64|]; (* Float *)
    [|v_instance;Array v_constr;v_constr;v_constr;Int|] (* Array *)
  |])
